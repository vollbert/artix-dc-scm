...
* ``assets`` - contains visual assets for showcasing this design on `Open Hardware Portal <https://openhardware.antmicro.com>`_
...
This project is published under the `Apache-2.0 <LICENSE>`_  license.
